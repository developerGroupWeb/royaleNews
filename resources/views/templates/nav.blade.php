    <!--Side navbar on mobile-->
      <nav class="d-md-none">
        <div class="header-mob navbar fixed-top shadow" style="background: #fff;">
          ...
          <div>
            <a href="Sing_in.php"><span class="fa fa-user-circle-o" style="color: #111;"></span></a>
          </div>
        </div>
        ...
        <div id="mySidenavLeft" class="sidenavLeft">
          <ul class="list-unstyled">
            ...
            <hr style="background-color: #fff;">
            <li class="li"><a href="Politique.php">Politique</a></li>
            <li class="li"><a href="Opinion.php">Opinion</a></li>
            <li class="li"><a href="Economie.php">Economie</a></li>
            <li class="li"><a href="Enquetes.php">Enquêtes</a></li>
            <li class="li"><a href="International.php">International</a></li>
            <li class="li"><a href="Sport.php">Sport</a></li>
            <li class="li"><a href="Sante.php">Santé</a></li>
            <li class="li"><a href="Culture.php">Culture</a></li>
            <li class="li"><a href="education.php">Education</a></li>
            <li class="li"><a href="tech_innovation.php">Tech-Innovation</a></li>
            <hr style="background-color: #fff;">
            <li class="li"><a href="">Top info</a></li>
            <li class="li"><a href="dossiers.php">Dossiers d'actualité</a></li>
            <li class="li"><a href="le_conseil_des_minitres.php">Le conseil des minitres</a></li>
            <li class="li"><a href="histoire_dafrique.php">Histoire d'afrique</a></li>
    ...
    <div class="d-none d-md-block sticky-top">
      <nav class="navbar navbar-dark navbar-expand-sm" style="background: #000000;">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="Politique.php"><strong>Politique</strong></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Economie.php"><strong>Economie</strong></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Opinion.php"><strong>Opinion</strong></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Enquetes.php"><strong>Enquêtes</strong></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Sport.php"><strong>Sport</strong></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Sante.php"><strong>Santé</strong></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="International.php"><strong>International</strong></a>
            </li>
          </ul>
          <div class="navbar-nav ml-auto open-searchBar">
