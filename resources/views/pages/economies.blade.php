...
<div class="container-fluid">
  <div class="row">
    <div class="">
      <h1 class="m-4"><strong>Econimie</strong></h1>
    </div>
  </div>
  <hr>
</div>
    ...
    <div class="col-lg-8">
      ...
      <div class="row">
        ...
        <div class="card-deck">
          <div class="card mb-3 bg-white">
            <a href="#">
              <img class="img-fluid w-100 h-100" src="bookstore/images/880x495_551979.jpg" alt="First slide">
            </a>
      ...
      <div class="row">
        <div class="card-deck">
          <div class="card mb-3 bg-white">
            <a href="#">
              <img class="img-fluid w-100" src="bookstore/images/gvbuyb.jpg" alt="First slide">
            </a>
      ...
      <div class="row pb-4 mb-4" style="background-color: #333;">
        <div class="col-12 sections-titles">
          ...
          <div class="card-columns">
            <div class="card">
              <a href="#"><img class="img-fluid w-100" style="max-height: 400px;" src="bookstore/images/gvbuyb.jpg" alt="Card image cap">
