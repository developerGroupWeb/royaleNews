            ...
            <div class="col-md-8 order-last order-md-first">
                ...
                <div class="row">
                    <div class="card-columns">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><a href="">Une de chaque categarie de la position priorite trois. six rubriques. Trois par ligne</a></h5>
                                <small class="text-muted">Rubrics</small>
                                <p class="card-text">Une de chaque categarie de la position priorite trois. Trois rubriques.</p>
