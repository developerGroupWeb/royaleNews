		...
		<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-12 offset-0 singin-content bg-white py-4 px-5 mb-5 shadow" style="margin-top: 100px; border-radius: 20px;">
			<div class="row">
				...
				<div class="col-sm-12" style="margin-bottom: 50px;">
					...
					<a href="{{route('rubric.all',['rubrics' => 'singup'])}}" class="btn col-sm-10 offset-sm-1 col-10 offset-1 singbg-btn" style="padding: 14px; margin-top: 10px;"><h3 class="singup text-white">Créer un compte</h3></a>
				</div>
			</div>
		</div>
	</div>
